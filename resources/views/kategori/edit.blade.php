                ...
                <div class="card-body">
                    ...
                    <form action="" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="kode_kategori" id="kode_kategori" class="form-control" value=>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="slug_kategori" id="slug_kategori" class="form-control" value=>
                        </div>
                        <div class="form-group">
