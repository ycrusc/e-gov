                ...
                <div class="card-body">
                    ...
                    <form action="" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="kode_produk" id="kode_produk" value=class="form-control">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="slug_produk" id="slug_produk" value=class="form-control">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="satuan" id="satuan" value=class="form-control">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
